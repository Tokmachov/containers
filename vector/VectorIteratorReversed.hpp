...
template <typename Value>
ft::VectorIteratorReversed<Value> &operator+(const ft::VectorIteratorReversed<Value> & it, typename ft::VectorIteratorReversed<Value>::difference_type offset)
{
...
template <typename Value>
ft::VectorIteratorReversed<Value> &operator+(typename ft::VectorIteratorReversed<Value>::difference_type offset, const ft::VectorIteratorReversed<Value> & it)
{
    it._storagePtr -= offset;
    return it;
}
