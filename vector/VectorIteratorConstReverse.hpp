...
template <typename Value>
VectorIteratorConstReverse<Value> &operator+(const VectorIteratorConstReverse<Value> & it, typename VectorIteratorConstReverse<Value>::difference_type offset)
{
...
template <typename Value>
VectorIteratorConstReverse<Value> &operator+(typename VectorIteratorConstReverse<Value>::difference_type offset, const VectorIteratorConstReverse<Value> & it)
{
    it._storagePtr -= offset;
    return it;
}
